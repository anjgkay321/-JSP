...
public class ParameterTestController {
	...
	public void page01(PersonDto dto,Model model) {
		...
		//유효성
		//서비스
		//뷰이동 데이터전달(Model 객체 - DispatherServlet(FC))
	...
	public String page02(PersonDto dto,Model model) {
		...
		//뷰이동 데이터전달(Model 객체 - DispatherServlet(FC))
		model.addAttribute("dto",dto);
		model.addAttribute("test2","test1Value");
		//반환자료형 void :/WEB-INF/views/param/page01.jsp
		return "param/page01";
	}
	...
	public String page03(PersonDto dto,Model model) {
		...
		model.addAttribute("dto",dto);
		model.addAttribute("test3","test_Value_3");
	...
	public String r2(Model model,
		...
		model.addAttribute("r1",r1); //쿼리스트링
