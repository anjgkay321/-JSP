...
public class JoinDto {
	...
	public JoinDto(String regist_month, String c_no, String c_name, String class_name, String class_area,
	...
	public String toString() {
		return "JoinDto [regist_month=" + regist_month + ", c_no=" + c_no + ", c_name=" + c_name + ", class_name="
