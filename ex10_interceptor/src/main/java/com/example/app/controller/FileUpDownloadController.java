...
public class FileUpDownloadController {
	...
	public void upload(@RequestParam("files") MultipartFile[] files) throws IllegalStateException, IOException {
		...
		// 업로드 경로 설정
		String UploadPath = ROOT_PATH + File.separator // '/'
				+ UPLOAD_PATH + File.separator + folderName + File.separator;
	...
	@ResponseBody
	public ResponseEntity<Resource> download(@RequestParam String path) throws UnsupportedEncodingException {
